...
var UI = {
	Tabview: {
        ...
        defaultoptions.width = '500px';
  			...
  			defaultoptions.inactiveColorText = 'rgb(255,255,255)'; /* black */
  			defaultoptions.activeColorBackground = "rgb(80,124,54)"; /* dark blue */
  			defaultoptions.inactiveColorBackground = "rgb(53,53,53)"; /* white */
